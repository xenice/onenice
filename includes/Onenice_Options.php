...
class Onenice_Options
{
    ...
    public function global($wp_customize)
    {
        ...
        $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'site_icon',
        	[
    ...
    public function slides($wp_customize)
    {
        ...
        $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'slides_image_1',
        	[
        ...
        $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'slides_image_2',
        	[
        ...
        $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'slides_image_3',
        	[
    ...
    public function archive($wp_customize)
    {
        ...
        $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'site_thumbnail',
        	[
        ...
        $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'site_loading_image',
        	[
