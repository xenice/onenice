...
js;
    ...
    {
        $style = $field['style']??'regular';
        $button = sprintf('<button class="button button-default xenice-img-select-%s">%s</button>',$field['id'],_t("Select"));
...
js;
    ...
    private function imgs($field)
    {
        ...
        $str .='</div>';
        $str .= sprintf('<button class="button button-default xenice-img-add-%s">%s</button>',$field['id'],_t("Add"));
