		...
		<ul role="navigation">
		  <?php
			...
			if ( ! function_exists( 'dynamic_sidebar' ) || ! dynamic_sidebar($page_type) ) :
				?>
			<li class="widget widget_tag_cloud" ><h3><?php _e( 'Tag Cloud' ); ?></h3>
				<div class="tagcloud">
				<?php
				wp_tag_cloud(
					array(
			...
			<?php if(is_single()):?>
			<li class="widget widget_recent_entries" ><h3><?php _e( 'Recent Posts' ); ?></h3>
				<ul>
    				<?php
    				$r = new WP_Query(
            				array(
			...
			<?php endif;?>
			<?php if(is_home()):?>
    			<li class="widget" ><h3><?php _e( 'Archives' ); ?></h3>
    				<ul>
