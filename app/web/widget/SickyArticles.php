...
class SickyArticles extends \WP_Widget
{
    public function __construct()
    {
        $widget_ops = array( 'description' => _t('Xenice Sicky Articles') );
        parent::__construct( 'xenice_sicky_article', _t('Sicky Articles'), $widget_ops );
    }
    ...
    {
        $instance = wp_parse_args( (array) $instance, ['name'=>_t( 'Sicky Articles'), 'limit' => 8] );
